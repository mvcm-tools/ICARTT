...
# add group and site name to column headers
    ...
    # first, check if units are already in column names, if it isn't, add it to the end of the column names
    ...
    # if unit contains spaces, don't add it
        if ' ' in unit:
            pass
...
df_vars = ['ADEC_advisory_flag_Fairbanks', 'House_indoor_PicarroG2103_NH3_ppb', 'House_outdoor_PicarroG2103_NH3_ppb', 'House_PicarroG2307_H2CO_ppb', 'House_PicarroG2401_CO_ppm', 'House_AMS_SO4', 'House_AE33_BC_smth', 'CTC_temp_6m_C', 'CTC_COFFEE_CH2O_COFFEE_ppbv', 'CTC_AERIS_CH2O_AERIS_ppbv']
